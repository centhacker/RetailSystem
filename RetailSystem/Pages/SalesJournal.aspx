<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="SalesJournal.aspx.cs" Inherits="RetailSystem.Pages.SalesJournal" %>
        ...
        <asp:UpdatePanel ID="updateGridSalesJournal" runat="server">
            <ContentTemplate>
                ...
                <h2 class="title-divider">
                    <span>Add <span class="de-em">New Sale Transaction</span></span>
                    <small>Add Products to Sale</small>
                </h2>
                <h5>Client
                </h5>
                <div class="form-group">
                    <asp:DropDownList ID="ddlClient" runat="server" CssClass="form-control" AutoPostBack="true"></asp:DropDownList>
                </div>
                <h5>WareHouse
                </h5>
                <div class="form-group">
                ...
                <asp:GridView ID="grdSales" runat="server"
                    ...
                    GridLines="None" OnRowDeleting="grdSales_RowDeleting" OnSelectedIndexChanged="grdSales_SelectedIndexChanged" OnRowCommand="grdSales_RowCommand" OnRowDataBound="grdSales_RowDataBound">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Cost Price">
                            <ItemTemplate>
                                <asp:Label ID="txtCp" runat="server" CssClass="grid-control " ForeColor="#009933" Font-Bold="True" AutoPostBack="true"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Sale Price">
                            <ItemTemplate>
                                <asp:TextBox ID="txtSp" runat="server" CssClass="grid-control form-control" AutoPostBack="true"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Total Units">
                            <ItemTemplate>
                                <asp:TextBox ID="txtUnits" runat="server" TextMode="Number" AutoPostBack="true" CssClass="grid-control form-control" OnTextChanged="txtUnits_TextChanged"></asp:TextBox>
                            </ItemTemplate>
