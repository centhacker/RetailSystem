...
{
    public partial class PaymentLine : System.Web.UI.Page
    {
        ...
        private void SetDataFromQueryString()
        {
            ...
            OrderVendorId = Request.QueryString["OrderClientId"].ToString();
            OrderVendorName = Request.QueryString["OrderClientName"].ToString();
            ...
            lblSalesOrderID.Text = OrderId;
            lblSalesOrderName.Text = OrderName;
            lblSalesOrderCode.Text = OrderCode;
            lblSalesPaymentId.Text = OrderPaymentId;
            lblSalesClientId.Text = OrderVendorId;
            lblSalesClientName.Text = OrderVendorName;
            lblSalesTotalCost.Text = OrderAmountTotal;
            lblSalesAmountPaid.Text = OrderAmountPaid;
            lblSalesAmountRemaining.Text = OrderAmountRemaining;
                ...
                case 1:
                    {
                        ...
                        {
                            AccountId = ddlSaleAccount.SelectedValue;
                        }
