...
{
    public partial class AddSaleTypes : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                string salestypename = txtSaleTypeName.Text;
                Models.MsaleTypes mv = new Models.MsaleTypes();
                mv.name = salestypename;
                Classes.CSalesTypes ccv = new Classes.CSalesTypes();
                if (ccv.Save(mv) < 0)
                {
                    ShowFailMessage();
                }
