<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="ViewPayables.aspx.cs" Inherits="RetailSystem.Pages.ViewPayables" %>
                ...
                <ContentTemplate>
                    <asp:GridView ID="grdRec" runat="server" Width="940px" HorizontalAlign="Center"
                       ...
                       CssClass="table table-hover table-striped">
                        <Columns>
                            <asp:BoundField DataField="VendorName" HeaderText="Client Name" />
