<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="SetDefaultAccount.aspx.cs" Inherits="RetailSystem.Pages.SetDefaultAccount" %>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane fade in active" id="tab1">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlPurchaseAccount" CssClass="form-control" runat="server" ></asp:DropDownList>
                            </div>
                            <h5>Default Purchase Account
                  </h5>
                            <div class="form-group">
