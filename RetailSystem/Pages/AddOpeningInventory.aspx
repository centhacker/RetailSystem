<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="AddOpeningInventory.aspx.cs" Inherits="RetailSystem.Pages.AddOpeningInventory" %>
        ...
        <asp:UpdatePanel ID="updateGridSalesJournal" runat="server">
            <ContentTemplate>
                ...
                <h2 class="title-divider">
                    <span>Open <span class="de-em">Inventory</span></span>
