<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="ShopExpense.aspx.cs" Inherits="RetailSystem.Pages.ShopExpense" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="block">
        ...
        <h2 class="title-divider">
            <span>Add <span class="de-em">Shop Expense</span></span>
        ...
        <asp:UpdatePanel ID="updateClientForm" runat="server">
            <ContentTemplate>
                ...
                <asp:Button ID="btnSave" runat="server" CssClass="btn btn-primary" Text="Save" OnClick="btnSave_Click" ValidationGroup="frmBank" />
